...
/*****************************************************************/
signed char FAT_get_dir_struct(unsigned long clusterN ,char *strBuf)
{
  if(FATType==FAT32)
...
/*****************************************************************/
unsigned long FAT_get_cluster_number(unsigned long cluster,char *nam,unsigned char fileOrDir)
{
  if(FATType==FAT32)
...
/*****************************************************************/
signed char FAT_read_file(char *filename,unsigned long curCluster,unsigned int offset,char *dataBuf)
{
  if(FATType==FAT32)
...
signed char FAT_write_file(char *filename,unsigned long curCluster,unsigned long int fileSize,char *data,unsigned char flags)
{
  if(FATType==FAT32)
