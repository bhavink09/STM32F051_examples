...
signed char FAT_get_dir_struct(unsigned long ,char *);
unsigned long FAT_get_first_sector(unsigned long );
unsigned long FAT_get_cluster_number(unsigned long ,char* ,unsigned char );
unsigned long FAT_get_next_cluster(unsigned long );
signed char FAT_read_file(char *,unsigned long ,unsigned int ,char *);
