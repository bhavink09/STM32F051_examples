...
signed char F32_getDirStruct(unsigned long ,char* );
unsigned long F32_getFirstSector(unsigned long );
unsigned long F32_getClusterNumber(unsigned long, char * ,unsigned char);
unsigned long F32_getNextCluster(unsigned long );
signed char F32_readFile(char * ,unsigned long,unsigned int ,char* );
